...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/2bit_2to_1 _MUX/2bit_2to_1 _MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_2_bit_2_to_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MUX_2_bit_2_to_1.tcl -notrace
