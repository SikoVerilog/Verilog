...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Asign_4_1_LFSR_internal/Asign_4_1_LFSR_internal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_internal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LFSR_internal.tcl -notrace
