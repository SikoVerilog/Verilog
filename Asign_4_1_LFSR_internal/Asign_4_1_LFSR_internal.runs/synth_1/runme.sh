...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Asign_4_1_LFSR_internal/Asign_4_1_LFSR_internal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_internal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LFSR_internal.tcl
