...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/Block_RAM/Block_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log B_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source B_RAM.tcl
