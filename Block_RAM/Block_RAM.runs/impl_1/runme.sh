...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/Block_RAM/Block_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log B_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source B_RAM.tcl -notrace
