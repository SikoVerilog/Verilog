...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/perameterized_mux/perameterized_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log call.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source call.tcl -notrace
