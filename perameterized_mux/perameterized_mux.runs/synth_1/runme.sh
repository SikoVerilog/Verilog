...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/perameterized_mux/perameterized_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log call.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source call.tcl
