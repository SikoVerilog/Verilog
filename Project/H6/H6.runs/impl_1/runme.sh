...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H6/H6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H6.tcl -notrace
