...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H6/H6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H6.tcl
