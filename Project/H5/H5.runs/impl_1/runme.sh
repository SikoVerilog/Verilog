...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H5/H5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H5.tcl -notrace
