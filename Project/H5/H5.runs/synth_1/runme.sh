...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H5/H5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H5.tcl
