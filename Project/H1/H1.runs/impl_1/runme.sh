...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H1/H1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H1.tcl -notrace
