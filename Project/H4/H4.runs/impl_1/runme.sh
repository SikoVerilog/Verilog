...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H4/H4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H4.tcl -notrace
