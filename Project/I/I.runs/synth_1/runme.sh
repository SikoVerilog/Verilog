...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/I/I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I.tcl
