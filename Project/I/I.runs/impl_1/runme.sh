...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/I/I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I.tcl -notrace
