...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H3/H3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H3.tcl -notrace
