...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/I1/I1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I1.tcl -notrace
