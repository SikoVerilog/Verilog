...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/I1/I1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I1.tcl
