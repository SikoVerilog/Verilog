...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Project/H2/H2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log H2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source H2.tcl -notrace
