...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/DFF_for_loop/DFF_for_loop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFF_for.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFF_for.tcl
