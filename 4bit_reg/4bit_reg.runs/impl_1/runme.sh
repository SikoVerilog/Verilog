...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/4bit_reg/4bit_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Reg_4bit.tcl -notrace
