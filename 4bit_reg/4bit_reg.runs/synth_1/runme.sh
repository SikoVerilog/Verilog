...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/4bit_reg/4bit_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reg_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reg_4bit.tcl
