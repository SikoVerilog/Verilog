...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/Assign_test/Assign_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_assign.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_assign.tcl -notrace
