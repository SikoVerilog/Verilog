...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/Assign_test/Assign_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_assign.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_assign.tcl
