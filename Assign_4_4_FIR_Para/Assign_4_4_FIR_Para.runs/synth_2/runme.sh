...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Assign_4_4_FIR_Para/Assign_4_4_FIR_Para.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Para.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Para.tcl
