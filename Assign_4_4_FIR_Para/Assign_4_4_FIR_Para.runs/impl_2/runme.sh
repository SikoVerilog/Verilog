...
HD_PWD='C:/Users/Sanaullah/Documents/GitHub/Verilog/Assign_4_4_FIR_Para/Assign_4_4_FIR_Para.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Para.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_Para.tcl -notrace
