...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/multiplexer_with_case/multiplexer_with_case.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_case.tcl
