...
HD_PWD='C:/Users/Sanaullah/Desktop/Xilinx Project/multiplexer_with_case/multiplexer_with_case.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_case.tcl -notrace
